...
const Hero = ({ onAnimationComplete }: any) => {
  ...
  return (
    <section id="Home" className="w-full h-fit sm:h-[calc(100vh-70px)] pt-[50px]">
      ...
      <div className="w-full h-fit py-[10px] sm:py-[10px] px-1 sm:px-0">
        <div
          ref={bottomDivRef}
          className="w-full h-fit sm:h-[200px]  hover-target flex justify-center items-center py-2 sm:py-0 px-[20px] sm:px-[100px] overflow-hidden"
        >
          <h1 ref={bottomTextRef} className="text-white font-bold text-[20px] sm:text-[30px] leading-none text-center">
